        ...
        extend: {
            colors: {
                ...
                semantic: {
                    ...
                    'success-light': 'var(--colors-semantic-success-light)',
                    warning: 'var(--colors-semantic-warning)',
                    'warning-light': 'var(--colors-semantic-warning-light)',
                    error: 'var(--colors-semantic-error)',
                    'error-light': 'var(--colors-semantic-error-light)',
                    info: 'var(--colors-semantic-info)',
                    'info-light': 'var(--colors-semantic-info-light)',
                },
            },
            spacing: {
                0: 'var(--spacing-0)',
