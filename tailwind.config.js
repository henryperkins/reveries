        ...
        extend: {
            colors: {
                ...
                westworld: {
                    ...
                    'dark-brown': 'var(--colors-westworld-dark-brown)',
                    'near-black': 'var(--colors-westworld-near-black)',
                    black: 'var(--colors-westworld-black)',
                    gold: 'var(--colors-westworld-gold)',
                    'dark-gold': 'var(--colors-westworld-dark-gold)',
                    rust: 'var(--colors-westworld-rust)',
                    copper: 'var(--colors-westworld-copper)',
                    'dark-copper': 'var(--colors-westworld-dark-copper)',
